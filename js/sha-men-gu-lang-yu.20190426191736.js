...
r=function(){dpi=window.devicePixelRatio;var a='data-src'; if($('.js-219').hasAttr('src')) { a='src'; } $('.js-219').attr(a, (dpi>1) ? 'images/logo-48.png' : 'images/logo-24.png');
...
var wl = new woolite();
wl.init();
wl.addAnimation($('.js-219')[0], "1.00s", "0.00s", 1, 100);
